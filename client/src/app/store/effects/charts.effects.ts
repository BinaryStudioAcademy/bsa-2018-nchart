				...
				payload: [
					{
						...
						description:
							...
							'bars with heights proportional to the values that they represent.',
						dimensionSettings: [
							{
								multiple: false,
								description:
						...
						customizeSettings: [
							...
							},
							{
								...
								value: [],
								description:
									'List of uniques values in the dimension mapped as “color”. If set to ordinal, you can set a color for each value.' +
									' If set to linear, the app will try to find the minimum and maximum value contained in the dimension, and then creating ' +
									'a gradient among those two values.',
								option: 'Colour Scale',
								sysName: 'colourScale'
							}
						],
					...
					},
					{
						...
						customizeSettings: [
							...
							},
							{
								value: 4,
								description:
									'Pie chart will be disposed on a grid. This option allows to define how many pie charts must be drawn for each line.' +
							...
							},
							{
								value: ['size', 'name'],
								description:
									'Order of the arcs inside each pie chart. Can be ‘automatic’ (same order in each pie chart), ‘size’ ' +
									'(from biggest to smallest in each pie chart) or ‘name’ (alphabetical order).',
								option: 'Sort arcs by',
								id: 15,
								sysName: 'sortArcsBy'
							},
							{
								value: [],
								description:
									'List of dimensions headers dragged as ‘Arcs’. If set to ordinal, you can set a color for each value.' +
									' If set to linear, the app will try to find the minimum and maximum value contained in the dimension,' +
									' and then creating a gradient among those two values.',
								option: 'Colour scale',
								id: 16,
								sysName: 'colourScale'
							}
					...
					},
					{
						...
						description:
							'Alluvial diagrams allow to represent flows and to see correlations between categorical dimensions,' +
							' visually linking to the number of elements sharing the same categories. ' +
							'It is useful to see the evolution of cluster (such as the number of people belonging',
						dimensionSettings: [
							{
								multiple: true,
								description:
									'It accept multiple values, at least two column must be selected.' +
									' Each dragged column will define a step (a vertical group of nodes). ' +
									'The dragging order is also the visualization order. For each unique value found in each column a node will be created.',
								required: true,
								variable: 'Steps',
								type: ['string', 'number', 'date'],
								id: 7
							},
							{
								multiple: false,
								description:
									'Defines the weight of each line of the dataset. ' +
									'If not defined, all the lines will have the same weight.',
								required: false,
								variable: 'Size',
								type: ['number'],
								id: 8
						...
						customizeSettings: [
							...
							},
							{
								...
								description:
									'Sorting of nodes inside each step. It can be ‘automatic’ (trying to reduce the number of overlappings among flows),' +
									' ‘size’ (nodes ordered from the biggest to the smallest), and ‘alphabetical’.',
								option: 'Sort By',
								id: 21,
								sysName: 'sortBy'
							},
							{
								value: [],
								description:
									'The color of flows. The color is defined by the source node. ' +
									'For each unique value found in the dimension dragged as ‘steps’ a color is defined.',
								option: 'Colour scale',
								id: 22,
								sysName: 'colourScale'
							}
					...
					},
					{
						...
						customizeSettings: [
							...
							},
							{
								value: [],
								description:
									'If set to ordinal, you can set a color for each value; it lists all the unique values in the dimension mapped as “color”.' +
									' If set to linear, the app will try to find the minimum and maximum value contained in the dimension, ' +
									'and then it creates a gradient among those two values',
								option: 'Colour scale',
								id: 28,
								sysName: 'colourScale'
							}
